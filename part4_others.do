...
* Part 4: Calculation of the MLE standard errors of parameters and the values used in Figures 4a and 4b based on the estimates obtained in Part 3 (in STATA). 
*
*****
...
*            used in Figures 4a and 4b based on the estimates obtained in Part 3 
*            (in STATA). 
*           STATA version 15.0
*
*****
...
// Calculate the values for Figure 4a
...
// Calculate the values for Figure 4b
// (two-boy)
use "IVF_data_02.dta", replace
gen total_twins =  var2+var3+var4+var5
